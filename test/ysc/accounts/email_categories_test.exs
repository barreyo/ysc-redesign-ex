defmodule Ysc.Accounts.EmailCategoriesTest do
  ...
  describe "should_send_email?/2" do
    test "always sends account emails" do
      ...
      user_disabled = %{event_notifications: false, newsletter_notifications: false}
    ...
    test "respects event preferences" do
      ...
      assert EmailCategories.should_send_email?(user_enabled, "event_notification")
      refute EmailCategories.should_send_email?(user_disabled, "event_notification")
    end
  end
end
