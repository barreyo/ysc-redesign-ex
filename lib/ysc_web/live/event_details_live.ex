defmodule YscWeb.EventDetailsLive do
  ...
  def render(assigns) do
    ...
    <div class="py-6 lg:py-10">
      <div class="max-w-screen-lg mx-auto flex flex-wrap px-4 space-y-10 flex-col">
        <.live_component
        ...
        <div class="max-w-xl space-y-10">
          <div class="space-y-1">
            <p :if={@event.start_date} class="font-semibold text-zinc-600">
              <%= format_start_date(@event.start_date) %>
            </p>
            <h2 :if={@event.title} class="text-4xl font-bold leading-8"><%= @event.title %></h2>

            <p :if={@event.description != nil} class="font-semibold text-zinc-600 pt-2">
              <%= @event.description %>
            </p>
          </div>
          ...
          <div :if={@event.location_name != nil || @event.address} class="space-y-2">
            ...
            >
              ...
              <div id="event-map" class="hidden">
                ...
                <div>
                  <ul class="flex flex-wrap items-center justify-center py-4">
                    <li class="px-4">
                      <a class="group hover:zinc-800 hover:fill-zinc-800 transition ease-in-out duration-200">
                        <svg
                          stroke-width="0"
                          viewBox="0 0 320 512"
                          xmlns="http://www.w3.org/2000/svg"
                          class="w-6 h-6 text-zinc-600 fill-zinc-600 group-hover:fill-zinc-800 group-hover:text-zinc-800 transition ease-in-out duration-200"
                        >
                    ...
                    <li class="px-4">
                      <a
                        class="group hover:zinc-800 hover:fill-zinc-800 transition ease-in-out duration-200"
                        href=""
                      >
                        <svg
                          stroke-width="0"
