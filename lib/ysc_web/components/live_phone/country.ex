defmodule LivePhone.Country do
  ...
  @enforce_keys [:code, :name, :region_code]
  defstruct [:code, :name, :region_code, preferred: false]
  ...
  ```elixir
    ...
    {:ok, %LivePhone.Country{code: "US", name: "United States of America (the)", preferred: false, region_code: "1"}}
