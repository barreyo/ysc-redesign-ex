defmodule YscWeb.CoreComponents.SwiftUI do
  ...
  @doc """
  Renders the YSC logo for the native app.

  By default this loads the server-served image at `/images/ysc_logo.png`.
  You can override with a custom `url`, and customize styling via `class` / `style`.
  """
  @doc type: :component

  attr :url, :string, default: nil
  attr :class, :string, default: "main-logo"
  attr :rest, :global

  def logo(assigns) do
    assigns = assign_new(assigns, :url, fn -> "/images/ysc_logo.png" end)
