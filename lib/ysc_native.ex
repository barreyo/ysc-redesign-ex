defmodule YscNative do
  ...
  import YscWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {YscWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(:swiftui) do
    gettext_quoted =
      quote do
        import YscWeb.Gettext
      end

    core_components_quoted =
      quote do
        import YscWeb.CoreComponents.SwiftUI
      end
